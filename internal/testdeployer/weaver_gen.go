...
func init() {
	codegen.Register(codegen.Registration{
		Name:      "github.com/eberkley/weaver/internal/testdeployer/a",
		Iface:     reflect.TypeOf((*a)(nil)).Elem(),
		Impl:      reflect.TypeOf(aimpl{}),
		Listeners: []string{"lis"},
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return a_local_stub{impl: impl.(a), tracer: tracer, aMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/eberkley/weaver/internal/testdeployer/a", Method: "A", Remote: false, Generated: true})}
		},
	...
	codegen.Register(codegen.Registration{
		...
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return b_local_stub{impl: impl.(b), tracer: tracer, bMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/eberkley/weaver/internal/testdeployer/b", Method: "B", Remote: false, Generated: true})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
	...
	codegen.Register(codegen.Registration{
		...
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return c_local_stub{impl: impl.(c), tracer: tracer, cMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/eberkley/weaver/internal/testdeployer/c", Method: "C", Remote: false, Generated: true})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
	...
	codegen.Register(codegen.Registration{
		Name:  "github.com/eberkley/weaver/internal/testdeployer/d",
		Iface: reflect.TypeOf((*d)(nil)).Elem(),
		Impl:  reflect.TypeOf(dimpl{}),
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return d_local_stub{impl: impl.(d), tracer: tracer, dMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/eberkley/weaver/internal/testdeployer/d", Method: "D", Remote: false, Generated: true})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
