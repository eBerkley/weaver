...
func init() {
	codegen.Register(codegen.Registration{
		Name:  "github.com/eberkley/weaver/weavertest/internal/diverge/Errer",
		Iface: reflect.TypeOf((*Errer)(nil)).Elem(),
		Impl:  reflect.TypeOf(errer{}),
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return errer_local_stub{impl: impl.(Errer), tracer: tracer, errMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/eberkley/weaver/weavertest/internal/diverge/Errer", Method: "Err", Remote: false, Generated: true})}
		},
	...
	codegen.Register(codegen.Registration{
		Name:  "github.com/eberkley/weaver/weavertest/internal/diverge/Pointer",
		Iface: reflect.TypeOf((*Pointer)(nil)).Elem(),
		Impl:  reflect.TypeOf(pointer{}),
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return pointer_local_stub{impl: impl.(Pointer), tracer: tracer, getMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/eberkley/weaver/weavertest/internal/diverge/Pointer", Method: "Get", Remote: false, Generated: true})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
