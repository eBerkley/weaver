...
func init() {
	codegen.Register(codegen.Registration{
		Name:  "github.com/eberkley/weaver/examples/bankofanthos/balancereader/T",
		Iface: reflect.TypeOf((*T)(nil)).Elem(),
		Impl:  reflect.TypeOf(impl{}),
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return t_local_stub{impl: impl.(T), tracer: tracer, getBalanceMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/eberkley/weaver/examples/bankofanthos/balancereader/T", Method: "GetBalance", Remote: false, Generated: true})}
		},
