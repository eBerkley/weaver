...
func init() {
	codegen.Register(codegen.Registration{
		...
		RefData: "⟦7237a6f4:wEaVeReDgE:github.com/eberkley/weaver/examples/bankofanthos/ledgerwriter/T→github.com/eberkley/weaver/examples/bankofanthos/balancereader/T⟧\n",
	})
}
