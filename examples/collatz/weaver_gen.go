...
func init() {
	codegen.Register(codegen.Registration{
		Name:  "github.com/eberkley/weaver/examples/collatz/Even",
		Iface: reflect.TypeOf((*Even)(nil)).Elem(),
		Impl:  reflect.TypeOf(even{}),
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return even_local_stub{impl: impl.(Even), tracer: tracer, doMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/eberkley/weaver/examples/collatz/Even", Method: "Do", Remote: false, Generated: true})}
		},
	...
	codegen.Register(codegen.Registration{
		...
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return odd_local_stub{impl: impl.(Odd), tracer: tracer, doMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/eberkley/weaver/examples/collatz/Odd", Method: "Do", Remote: false, Generated: true})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
