...
func init() {
	codegen.Register(codegen.Registration{
		Name:  "github.com/eberkley/weaver/examples/chat/ImageScaler",
		Iface: reflect.TypeOf((*ImageScaler)(nil)).Elem(),
		Impl:  reflect.TypeOf(scaler{}),
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return imageScaler_local_stub{impl: impl.(ImageScaler), tracer: tracer, scaleMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/eberkley/weaver/examples/chat/ImageScaler", Method: "Scale", Remote: false, Generated: true})}
		},
	...
	codegen.Register(codegen.Registration{
		Name:  "github.com/eberkley/weaver/examples/chat/LocalCache",
	...
	codegen.Register(codegen.Registration{
		...
		NoRetry: []int{0, 1},
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return sQLStore_local_stub{impl: impl.(SQLStore), tracer: tracer, createPostMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/eberkley/weaver/examples/chat/SQLStore", Method: "CreatePost", Remote: false, Generated: true}), createThreadMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/eberkley/weaver/examples/chat/SQLStore", Method: "CreateThread", Remote: false, Generated: true}), getFeedMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/eberkley/weaver/examples/chat/SQLStore", Method: "GetFeed", Remote: false, Generated: true}), getImageMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/eberkley/weaver/examples/chat/SQLStore", Method: "GetImage", Remote: false, Generated: true})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
