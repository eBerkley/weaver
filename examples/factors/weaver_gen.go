...
func init() {
	codegen.Register(codegen.Registration{
		Name:   "github.com/eberkley/weaver/examples/factors/Factorer",
		Iface:  reflect.TypeOf((*Factorer)(nil)).Elem(),
		Impl:   reflect.TypeOf(factorer{}),
		Routed: true,
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return factorer_local_stub{impl: impl.(Factorer), tracer: tracer, factorsMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/eberkley/weaver/examples/factors/Factorer", Method: "Factors", Remote: false, Generated: true})}
		},
